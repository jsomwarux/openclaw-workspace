...
get_library_path(args.product) = os.path.join(os.path.dirname(__file__), "../agents/vibe-marketing/real-photos/vista/library.json")
PHOTOS_DIR = os.path.join(os.path.dirname(__file__), "../agents/vibe-marketing/real-photos/vista/")


def load_library():
    with open(get_library_path(args.product), "r") as f:
        return json.load(f)


def save_library(library):
    with open(get_library_path(args.product), "w") as f:
