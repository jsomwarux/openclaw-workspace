...
> Keep this file compact; put detail in the full doc. Warn above 7,000 chars.
...
- Credential/cache artifacts stay outside workspace memory; app-marketing GA4 OAuth cache belongs under `~/.cache/openclaw/app-marketing/`.
...
- `jtsomwaru.com`: AI ops homepage; `/property` remains PM Workflow Audit path. Kill loops wait for JT timer approval. App gates: Action Arena re-gate Aug 15 with Apple org conversion blocker; Glow maintain 2 hr/wk with Sept 1 data gate; Nash capped at 1 merged hr/wk; Vista killed 90 days.
...
- Directive-disabled crypto/job/content loops are not misses; no rerun/enable/alert/spend unless JT reactivates. Jul 21: MC 248 active / 12 high / 0 overdue; costs empty; Spanish paused; cron 72 total / 12 enabled / 0 suspicious; Daily Send cash-source conflict guard added; proactive research + AI tool notes logged.
