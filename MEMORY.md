...
- Aug 5 send queue: Altmark and DHCR both 20 days stale, August cash $0/$10K. Altmark aligns to high-priority MC; DHCR remains active in send surfaces but only medium/in-progress in MC. Do not send/escalate without JT approval. MSI kickoff is cleared and must not resurface.
...
- Health, cost tracker, proof guard, film review, and skills audit remain active. Aug 4 health flare protocol: zero-alcohol experiment, exercise/social exposure, prescriber this week for sertraline timing/bruxism/hopelessness; MC task `j576xpcx6jrtashfqms8weep8s8bvgbn`. Aug 5 protocol ops directive supersedes coaching/check-in behavior for the 14-day window: logistics only, no symptom advice/questions, no trend comments before Day 7.
