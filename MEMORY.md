...
## Active Clients
- **Altmark Group:** priority paid client. Dedicated PC installed in office; insurance expiration workflow is live in production, working after minor updates, and final 50% paid. Rent delinquency workflow initial 50% paid; JT is actively building/testing and this remains the top proof/revenue gate. Acceptance checklist/runbook are prepared for sample-report testing and now include legal/process-sensitive gates from official NY Courts context: prior demand/case/notice, recent payment, and legal/process flags route to manual review and cannot generate normal tenant-facing drafts. DHCR Lease Renewal Phase 1 assets are prepared but sequence after rent delinquency acceptance unless Altmark explicitly reprioritizes. Keep proof capture privacy-safe; public naming requires permission.
...
- Active cron count: 51 enabled / 77 total as of 2026-05-28. Responsibilities: morning brief, job market, niche monitor, crypto, content, App Marketing/ReelFarm, Sports GM, North Star, cost, health, passive-income pipeline. Heartbeat cron `eve-heartbeat-2h-002` disabled 2026-05-17 at JT request.
