...
Use when: replicating a UI design from a screenshot into code (web or mobile).
Trigger: JT says "clone this", "match this design", "build something like this" + sends a screenshot.
