...
[2026-05-28] 🔴 OpenClaw v2026.5.27 — active-stack security/runtime release while local runtime remains OpenClaw 2026.5.22. Highlights include stronger security/content boundaries, safer command/runtime env handling, no-auth Tailscale rejection, Telegram durable outbound delivery, Codex app-server reliability, Gateway hot-path cache/perf fixes, and provider/model coverage. Source: https://github.com/openclaw/openclaw/releases/tag/v2026.5.27 | Relevance: Eve/OpenClaw runtime | First action: open the release notes and approve/decline scheduling an OpenClaw update; do not update without JT approval. MC: not pushed; duplicate existing OpenClaw upgrade/security tasks already cover action and Skills backlog is above cap.
[2026-05-28] 🟠 Anthropic Cowork plugins — new Airtable plugin commit f9800bd9b3058821fa7ad2db153d2104c6761020 after yesterday Carta plugins. Source: https://github.com/anthropics/knowledge-work-plugins/commit/f9800bd9b3058821fa7ad2db153d2104c6761020 | Relevance: consulting/plugin architecture signal | MC: KB only; no current Airtable client/project action.
[2026-05-28] 🟡/🟢 KB only: Runway MCP official launch; AdRoll MCP open beta; Base MCP repeated from 2026-05-27; n8n Microsoft Agent 365 repeated from existing task; HN Claude daily-driver discussion; OpenRouter model catalog/pricing trackers. No new non-duplicate MC task pushed.
[2026-05-29] 🟠 Anthropic Cowork vibe-prospecting plugin — official marketplace addition connects Claude to live B2B company/contact data for prospect search, enrichment, filtering, export, CRM enrichment, and multi-step prospecting. Relevance: JT Somwaru Consulting prospect sourcing for NYC/metro SMB lanes; first action is to inspect the plugin docs and decide whether to create a no-install prospecting test brief for property managers/wholesale distributors. Source: https://github.com/anthropics/knowledge-work-plugins/commit/827b25f0cd4ff231567ef746281a874208bde56a
