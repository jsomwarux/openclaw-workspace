...
[2026-05-08] 🟡 OpenClaw v2026.5.7 — maintenance release with useful cron/status JSON, context-engine stale-history fixes, delivery failure reporting, and security/authorization hardening. Newer than state v2026.5.5, but no immediate JT action because existing MC OpenClaw upgrade tasks already cover reliability updates and no 48h break/fix surfaced. Source: https://github.com/openclaw/openclaw/releases/tag/v2026.5.7
[2026-05-08] 🟡 Anthropic advanced tool use — Tool Search Tool, Programmatic Tool Calling, and Tool Use Examples improve large tool-library agents/MCP systems, but this is API architecture signal rather than an immediate OpenClaw config change. Source: https://www.anthropic.com/engineering/advanced-tool-use
[2026-05-08] 🟡 n8n + Microsoft Agent 365 — n8n agents can appear inside Microsoft 365/Agent 365 surfaces; relevant to consulting demos, but duplicate MC task already exists: [🔴] n8n — Native Microsoft Agent 365 Integration. Source: https://blog.n8n.io/deploy-n8n-agents-that-show-up-as-members-of-the-team-inside-microsoft-apps/
[2026-05-08] 🟡 OpenRouter model additions — Gemini 3.1 Flash Lite, OpenAI gpt-chat-latest, Owl Alpha/free models observed; Gemini 3.1 Flash Lite is cheaper than MiniMax M2.7 on input but higher output, so no immediate default-routing change without benchmarking. Source: https://openrouter.ai/api/v1/models
