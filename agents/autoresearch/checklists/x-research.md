# Autoresearch Checklist — x-research

Score X research outputs against these yes/no checks:

1. Does it use fresh, relevant X results rather than generic web summaries?
2. Does it distinguish signal from noise and avoid over-weighting low-engagement posts?
