...
describe("taskToSignal", () => {
  ...
  test("carries agent operating-system metadata without changing the task lane", () => {
    const signal = taskToSignal({
      ...
      exactSteps: ["Open the role", "Review the package"],
      pasteReadyPrompt: "Review this package against the role.",
      pasteDestination: "Codex job-application chat",
      feedback: [{ id: "feedback-1", body: "Tighten the opening.", author: "jt", createdAt: 1_800_000_000_100 }],
