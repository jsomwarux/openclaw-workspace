...
5. Send punchy bullets with one action. Sections: SEND QUEUE (max 3 finished artifacts), priorities, news, niche intel, jobs, costs, workout, vibe queue, Nash X+Reddit excerpts/links when generated, Dynasty X, one action. As of 2026-06-11, Nash full text appears only when it is selected as a capped Send Queue item.
