...
- 2026-06-11 Phase 2A: audio input now auto-detects language (`tools.media.audio.language` removed); prior LCM DB backed up at `~/.openclaw/lcm.db.backup-20260611` and live `lcm.db` reset fresh. Moonshot fallback skipped until billing is resolved.
