...
- **Marketsmith:** active opportunity as of 2026-07-01. Sam asked JT about helping expedite 10-15 priority dashboards in 30 days with AI-generated insights, built in Azure with one active builder and data engineering support. Discovery with Amanda/David/Ed is expected tomorrow. Recommended positioning: 30-day dashboard acceleration / AI insights operating sprint covering dashboard triage, specs, QA/review cadence, stakeholder translation, AI insight patterns, and handoff. Avoid raw Azure engineering staff augmentation. Client OS initialized at `memory/clients/marketsmith/`; discovery prep at `memory/clients/marketsmith/discovery-prep-2026-07-01.md`.
