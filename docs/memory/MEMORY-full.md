...
- 2026-08-19 active mandate: JT's final 90 Day Playbook runs through 2026-11-17. Durable copy: `memory/operating-mandates/90-day-playbook-2026-08-19.md`. It supersedes prior strategy/positioning guidance where the two conflict. Scoreboard is cash collected. Nothing else counts as progress. Input metric is 2 priced conversations per week, meaning JT told a real buyer a real number. Positioning: "You take one messy business process, build a controlled AI system around it, and leave behind proof the business can trust." Say this exact thing. Do not add "any industry" or explain agents building agents. NYC/NJ property managers and building owners first.
...
- 2026-08-19 90 Day Playbook offer stack: Workflow Audit $1,500 flat for one week; Build $6,000-$12,000 fixed, three to five weeks, 50% up front and 50% on acceptance; Managed AI Ops $1,500/month after the monthly report exists. Partner Studio is later, not now, except Altmark.
- Frozen through 2026-11-17: niche research system, self-improving cron/agent harness, knowledge ingestion/skill converter work, per-domain lexicons, Mission Control Phase 3, all four app lanes, Guyana, Bustem, $500 website offer, and any new skill written outside paid delivery. Re-entry test: produces an invoice inside 90 days. If JT asks for something frozen, name that it is on the freeze list and ask whether he is overriding it; do not execute first and do not talk him out of it.
...
- 2026-08-18 positioning refinement: strongest frame is controlled AI operating systems for messy business workflows. Best-fit opportunities have recurring work, messy inputs, multiple systems, unclear ownership, exception handling, approval risk, and proof requirements.
...
## Active Clients
- 2026-06-11 correction: Altmark insurance final 50% and rent delinquency initial 50% have been collected. Superseded by the 2026-08-10 precision gate below: rent delinquency is blocked on AppFolio ledger cleanup, billing@ credential re-point, threshold column decision, holiday dates, attorney sign-off, canary send approval, and JT adding `outreach_id` as the 16th Outreach Log header before the next test. Older Aya StreetEasy/co-living notes are superseded by the 2026-08-10 Gil/Maiky split below.

- 2026-07-16 canonical alignment: authoritative state lives at `memory/canonical/jt-mission-control-state-2026-07-16.md` except where later corrections supersede it. MSI / Marketsmith moved from signed active delivery to closed/accepted on 2026-08-17; Governed AI Ops methodology remains generic-first, with MSI-specific configs/deliverables kept out of JT's reusable repo. The prior Karen-referral-ready, Aya-single-client, and Ron/Yair-watch-only phrasing is stale after the 2026-08-10 correction.

- 2026-08-10 JT sync correction supersedes the stale parts of the 2026-07-16 alignment: split Altmark FTE + NewCo from Ron/BDT; treat Altmark FTE + NewCo as active negotiation with Yair and Adai, with employment and NewCo as separate contracts and JT's existing systems/toolkit/playbook remaining personal IP. Ron/BDT Diamond District is separate watch-only and Ron has not been briefed on the real-estate developments. 2026-08-19 Playbook supersedes the older Karen/Guyana status where conflicting: Karen/SoberLife is referral-ask eligible, and Guyana is frozen through 2026-11-17 unless JT explicitly overrides. Aya is two clients/lanes: Gil construction dashboard is complete/paid/referral-eligible; Maiky is a separate live opportunity on hold after cost review. DHCR proposal went to Matt and routes as delivery-track; do not chase deposit inside the compensation negotiation thread. Mission Control active-count health must be judged against the playbook write contract; quote counts only when JT tells a real buyer a real number. Collected dollar figures must cite the payments ledger; `memory/pipeline.jsonl` is forecast-only.

- **Karen Vitale / SoberLife-Coach:** complete and paid as of the 2026-07-16 canonical alignment. Remove from active cash pipeline; closed-won. As corrected 2026-08-10, Karen referral ask is NOT eligible until written SEO expectation reset and handoff completion: design files, documented credentials, final paid invoice, and Google Business Profile.
...
- 2026-08-10 Altmark delinquency gate: workflow is 33 nodes / 91 passing tests / deactivated. Client-side gates are Yair clears AppFolio ledgers, billing@ credential re-point, threshold column decision, holiday dates, attorney sign-off, and canary send approval. JT-owned blocker: add `outreach_id` as the 16th column header on the Outreach Log tab before the next test run.
- **Aya / Gil / Maiky:** Gil construction dashboard is complete and paid; Gil referral ask is eligible. Maiky is separate from Gil/Aya dashboard and remains live/on hold after his cost review: proposal was 6 sheet automations plus 1 weekly delinquency report, with an unbundled entry point of delinquency report plus per-automation add-ons. StreetEasy monthly retainer no longer exists.
- **MSI / Marketsmith:** closed/accepted client engagement as of 2026-08-17. 80-hour fixed-scope Nexus engagement, signed value $10,800, invoicing 50% kickoff and 50% completion; kickoff 50% cleared 2026-07-28. All four SOW deliverables were delivered and accepted; client technical lead independently re-verified the work on MSI systems and confirmed acceptance to the exec team in writing on 2026-08-17. Completion invoice MSI-002 for $5,400 was sent 2026-08-18, Net 15, due 2026-09-02; flag if unpaid 2026-09-03. Remaining polish items sit with the client's technical lead, not JT. Follow-on lane is open for more clients through onboarding pipeline, context-updater agent, budget/flight-dates modal, QA coverage across production clients, and ongoing maintenance, but route scope conversation through technical lead first, then budget owner. Do not propose wiring QA into MSI's release flow because they have claimed it in-house. Current rate was explicitly the initial-project rate; flag before quoting expanded scope. Hard IP boundary: generic methodology is JT's; MSI-specific configs/deliverables are MSI's and must never enter JT's reusable repo. Reusable proof points are anonymized only: 500+ test cases across six quality checks, 224 mutation-tested behaviours, primary spend total computed by four independent query grains agreeing to the cent, fiscal calendar verified against source for every day in coverage by independent logic, 11 defects found/fixed only in "tool working" case-study framing, and delivery inside fixed 80 hours with client re-verification. No public/client-facing client-name use until approved. Client internal hours-saved estimates are blocked from proposals/posts/pages until permission and attribution are granted. Client OS initialized at `memory/clients/marketsmith/`; proposal/content should point to `ENGAGEMENT_BUILD_RECORD.md` privately and `case-study-analytics-platform.md` for anonymized proposal proof rather than reconstructing.

## Pipeline / Business Development
- 2026-08-19 active playbook pipeline is the warm list only before strangers: Ed, Sam, Gil, Karen, Maiky, Yair, Adi, Matt, Ron. Current asks: Ed follow-on plus two intros; Sam referral ask; Gil ask who else in his network is drowning in paperwork; Karen referral ask; Maiky restart paused work or ask who else at Aya needs it; Yair and Adi force partnership decision and ask for association intros; Matt asks what is still manual on his side; Ron asks whether jeweler clients need the same thing property managers need.
...
- 2026-08-19 update: all four app lanes are frozen through 2026-11-17 unless JT explicitly overrides after the freeze prompt. Old app-distribution and re-gate rules are superseded where they conflict with the playbook.
...
- Action Arena: superseded by 2026-08-19 Playbook freeze. All app lanes are frozen through 2026-11-17 unless JT explicitly overrides.
...
- 2026-08-19 Mission Control write contract extension through 2026-11-17: do not create or queue Strategy/Positioning, research, market discovery, system design, or tooling tasks unless explicitly overridden or invoice-producing inside 90 days. Frozen/off-contract active tasks should be archived or kept out of JT's active board.
- Critical commands/paths: `TOOLS.md`.

## Active Automation / Crons
- 2026-08-19 mandate supersedes proactive research/tooling appetite: the niche research system, self-improving cron and agent harness, knowledge ingestion/skill converter work, per-domain lexicons, and Mission Control Phase 3 are frozen through 2026-11-17 unless JT explicitly overrides. Existing safe health/cost/proof/status infrastructure may remain for stability, but do not create new research/tooling/system-design tasks.
...
- 2026-07-23: JT requested a nightly reminder to run the Claude Daily Delta Packet prompt and paste the output back to Eve. Created `Nightly Claude Delta Packet Reminder` (`fbae700d-4e23-414a-8a4e-dc563176d4b3`) at `0 22 * * * America/New_York`, isolated `agentTurn`, Telegram announce to `6608544825`. Registry verified as 13 enabled / 60 disabled / 73 total; cron volume guard green at 50/wk, 7.14/day, 4.14 agentTurn/day, no warnings or schedule collisions.
- 2026-07-23: Added one-shot reminder `Reminder: text Brandon about gym membership doctor's note` (`74a5b557-084e-4632-b3de-4b8c9cb5ac62`) for 2026-07-24 1:00PM ET, isolated `agentTurn`, Telegram announce to `6608544825`, `deleteAfterRun:false` after correcting the tool default. Registry verified as 14 enabled / 60 disabled / 74 total; cron volume guard still green at 50/wk, 7.14/day, 4.14 agentTurn/day, one expected unknown enabled `at` schedule, no warnings/collisions.
...
- Current strategy through 2026-11-17: cash collected, 2 priced conversations/week, paid delivery, and warm-list asks. App-growth next moves are frozen unless JT explicitly overrides and the work produces an invoice inside 90 days.
...
- Daily Send Sheet sent at 07:32 with Altmark delinquency inputs escalation, MSI kickoff confirmation, and DHCR Phase 1 deposit chase. Later JT approved data-surface reconciliation only: MSI was signed active delivery and the then-current action was kickoff invoice `$5,400`; this was superseded by 2026-08-17 closed/accepted state and 2026-08-18 completion invoice MSI-002.
...
## 2026-07-20 Heartbeat Memory Maintenance
- Active-hours baseline through 22:00: Mission Control audit/API ok at 248 active-like / 12 high / 0 overdue / 0 errors / 0 changes; cost alerts empty; Spanish paused with `last_lesson_date=2026-05-24`, day 73/week 13.
- Morning Brief/Daily Send Sheet had already delivered earlier in the day; heartbeats did not duplicate sends or notifications. Current send surface remained Altmark rent-delinquency inputs/escalation plus MSI kickoff invoice action; no external send, invoice, payment link, or client message was sent by Eve.
- Cron registry checked with node@22 PATH and `--all`: 72 total, 12 enabled, 0 suspicious rows with `consecutiveErrors >= 2` or `lastRunStatus=error`. Duplicate `lossless-claw` plugin-id warning persisted and stayed benign. No blind reruns or cron mutations were performed.
- 10AM missed-cron gate passed: Outreach Pipeline full UUID ran with preflight PASS and no external outreach; crypto morning remained intentionally disabled under July directives, with no rerun, enablement, alert, X/API spend, market pull, or recommendation artifact.
...
## 2026-07-23 Heartbeat Memory Maintenance
- Active-hours baseline through 18:12: Mission Control audit/API ok at 248 active-like / 12 high / 0 overdue / 0 errors / 0 changes; cost alerts empty; Spanish paused with `last_lesson_date=2026-05-24`, current day 73/week 13.
- Daily Send Sheet had already delivered with Altmark delinquency, MSI kickoff invoice, DHCR deposit chase, and `$0` MTD / `$10,000` gap. Heartbeats did not send invoices, client messages, external outreach, payment links, or Telegram alerts.
- Cron state after JT-requested `Nightly Claude Delta Packet Reminder`: 73 total / 13 enabled, volume guard green at 50 estimated weekly invocations, 7.14/day, 4.14 agent-turn/day, no warnings/collisions/unknowns. Only suspicious enabled row remains Weekly Systems Review `b2ca53ab-0c07-4a22-8424-9d39bf988405`, still known historical Jul 19 pseudo cost-tracker metadata; no blind rerun or cron mutation.
- 10AM film review added command-form guidance to `docs/agents/heartbeat-extended-rules.md` for node@22 PATH, normalized Mission Control jq, and avoiding pseudo-command text. 14:12 noted one local jq bracket/quoting failure, then the corrected normalized query succeeded; no config change needed.
- Proactive dedupe honored: 10:12 added PM AI compliance proof research, 14:12 added AI-tool monitoring on agent registries/identity/MCP gateways/runtime policy/audit logs, and 18:12 skipped directive-disabled/constrained crypto/job/content lanes. Compact `MEMORY.md` was already current at 6,997 bytes, so memory maintenance updated this expanded rollup without forcing a compact rewrite.

## 2026-07-27 Heartbeat Memory Maintenance
- Active-hours baseline through 18:12: Mission Control audit/API ok at 248 active-like / 12 high / 0 overdue / 0 errors / 0 changes; cost alerts empty; Spanish paused with `last_lesson_date=2026-05-24`, current day 73/week 13.
- Daily Send Sheet delivered with Altmark rent-delinquency unblock packet, MSI kickoff invoice action, and DHCR deposit/start-slot chase as the three due sends; verified cash remains `$0` MTD with `$10,000` gap. Eve did not send client messages, invoices, external outreach, payment links, or Telegram alerts.
- Cron volume guard stayed green at 13 enabled jobs, 50 estimated weekly invocations, 7.14/day, 4.14 agent-turn/day, no warnings/collisions/unknowns. Weekly Systems Review `b2ca53ab-0c07-4a22-8424-9d39bf988405` remained the only suspicious enabled row after its natural run ended red on pseudo `run openclaw cron (agent)` despite useful report/Telegram output; 14:12 patched the live prompt with literal node@22 PATH-prefixed OpenClaw commands and no blind rerun.
- Proactive dedupe honored: 12:52 added PM control-record buyer-language research, 14:12 added AI-tool monitoring on policy engine -> identity -> audit log proof, and 18:12 used memory maintenance to refresh this expanded rollup plus the compact automation line.

## 2026-07-31 Heartbeat Memory Maintenance
- Active-hours baseline through 12:13: Mission Control audit/API ok at 250 active / 12 high / 0 changes; live `/api/tasks` returned 251 total and 12 active high/critical; cost alerts empty; Spanish paused with `last_lesson_date=2026-05-24`.
- Cron state: 74 total / 13 enabled. Only suspicious enabled row remains Weekly Systems Review `b2ca53ab-0c07-4a22-8424-9d39bf988405`, consecutiveErrors 6, from the known 2026-07-27 pseudo `run openclaw cron (agent)` failure; next natural run 2026-08-02 10:00. No blind rerun or cron mutation. Cron volume guard green at 50 estimated weekly invocations, 7.14/day, 4.14 agent-turn/day, no warnings/collisions/unknowns.
- Outreach Pipeline latest run was 2026-07-31 03:00 ok with preflight PASS, eligible copy-review 0, warm-up holds 1, skipped 57, tasks/docs created none, and external outreach sent no. Pending Task Processor ran 2026-07-31 10:30 ok. Crypto recurring jobs remain disabled/refused; no rerun, alert, spend, recommendation, wallet, payment, trade, or enablement.
- MSI stale-routing fix completed: kickoff 50% ($5,400) cleared/source-confirmed 2026-07-28; MSI is signed delivery/completion-invoice context only and must not appear in active sends. `memory/send-queue.md` now lists only Altmark rent-delinquency escalation and DHCR Lease Renewal Phase 1 deposit.
- Proactive dedupe honored: Jul 31 lanes covered client/market research, AI-tool monitoring, job-market pulse, content drafting, and memory maintenance. Review-only LinkedIn draft `memory/drafts/linkedin-run-control-action-record-2026-07-31.md` passed voice guard score 100 and was not posted, scheduled, sent, uploaded, or banked.

## 2026-08-01 Heartbeat Memory Maintenance
- Active-hours baseline through 12:36: Mission Control audit/API ok at 250 active / 12 high / 0 overdue / 0 changes; live `/api/tasks` returned 251 total and 12 active high/critical; cost alerts empty; Spanish paused with state check ok/paused.
- Cron state: 74 total / 13 enabled. Only suspicious enabled row remains Weekly Systems Review `b2ca53ab-0c07-4a22-8424-9d39bf988405`, consecutiveErrors 6, from the known 2026-07-27 pseudo `run openclaw cron (agent)` failure; next natural run 2026-08-02 10:00. No blind rerun or cron mutation. Cron volume guard green at 50 estimated weekly invocations, 7.14/day, 4.14 agent-turn/day, no warnings/collisions/unknowns.
- Daily Send Sheet ran 2026-08-01 07:30 ok/delivered to numeric Telegram with fallbackUsed=true. Active sends are Altmark rent delinquency escalation/default-forward note and DHCR Lease Renewal Phase 1 deposit Matt/Yair start-slot chase; MSI kickoff remains excluded because the kickoff payment cleared. Outreach Pipeline ran 03:00 ok/PASS with eligible copy-review 0, warm-up holds 1, skipped 57, and no external outreach. Pending Task Processor ran 10:30 ok/no pending tasks; next 18:30.
- Crypto recurring jobs remain disabled/refused with no next run; no rerun, alert, spend, recommendation, wallet, payment, trade, or enablement. Same-day Watchdog launch-window reminder remains medium/background: half-day build + demo/dry run, deliverability audit before any cold send.
- Proactive dedupe honored: Aug 1 lanes covered client/market research (`memory/research/property-ops-automation-approval-record-2026-08-01.md`), AI-tool monitoring, job-market pulse, content drafting, and memory maintenance. Review-only LinkedIn draft `memory/drafts/linkedin-ai-adoption-approval-boundary-2026-08-01.md` passed JT voice guard score 100 and content distribution guard; it was not posted, scheduled, sent, uploaded, or banked.

## 2026-08-02 Heartbeat Memory Maintenance
- Active-hours baseline through 13:12: Mission Control audit/API ok at 250 active / 12 high / 0 overdue / 0 changes; live `/api/tasks` returned 252 total and 12 active high/critical; cost alerts empty; Spanish paused with state check ok/paused.
- Cron state: 74 total / 13 enabled / 0 suspicious enabled rows. Weekly Systems Review is no longer stale after its natural 2026-08-02 10:00 run finished ok at 10:06, saved `memory/audits/weekly-systems/2026-08-02-weekly-systems-review.md`, delivered Telegram message `25376`, created MC task `j571gbnxsn6h535tkak5fyv6p98bp289`, and next runs 2026-08-09 10:00. The 10:06 heartbeat patched the live WSR prompt from stale Node 22 to Node 26 OpenClaw command guidance and marked the MC task done.
- Daily Send Sheet ran 2026-08-02 07:30 ok/delivered to numeric Telegram `6608544825` with Altmark rent delinquency remainder and DHCR Lease Renewal Phase 1 deposit due, both 17 days stale, `$0` August MTD, and `$10,000` gap. Outreach Pipeline ran 03:00 ok/PASS with eligible copy-review 0, warm-up holds 1, skipped 57, and no external outreach. Pending Task Processor ran 10:30 ok; next 18:30. Cron volume guard remained green at 50 estimated weekly invocations, 7.14/day, 4.14 agent-turn/day, no warnings/collisions/unknowns.
- Crypto recurring jobs remain disabled/refused with no next run; no rerun, alert, spend, recommendation, wallet, payment, trade, or enablement. Weekly Intelligence Synthesis cron remains disabled; Sunday intelligence was handled manually and kept intelligence-only.
- Proactive dedupe honored: Aug 2 lanes covered Sunday weekly intel (`memory/content/weekly-intel-brief.md`), AI-tool monitoring (`memory/ai-tools.md`), WSR/film-review owner-surface fix, directive-limited job-market pulse (`memory/job-market.md`), review-only content draft (`memory/drafts/linkedin-property-ops-source-to-decision-trail-2026-08-02.md`), and memory maintenance. The Aug 2 draft passed `CONTENT_DISTRIBUTION_GUARD_PASS` and `JT_VOICE_GUARD_PASS score=100 min=80`; it was not posted, scheduled, sent, uploaded, banked, or pushed to Notion.
