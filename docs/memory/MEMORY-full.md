...
- 2026-07-02 JT project-state update: Karen Vitale is active with domain move, Psychology Today/LinkedIn/content schedule, and remaining half of $1,500 outstanding. Aya needs full Fable dashboard review, final updates, and Gil review meeting. Altmark next execution path is Conductor on Beelink using Danny's guide, configuration needed for the rent delinquency bot, then Fable final playbook review. Marketsmith needs prep for today's Sam/team meeting and final playbook/proposal. Apps need Apple follow-up, Fable review of app ideas for UGC/paid onboarding fit, Yair idea exchange, Fable playbooks, and Codex/Opus implementation for selected work.

- **Karen Vitale:** active client/payment lane as of 2026-07-02. JT finished the website on 2026-07-02; live verification passed at `https://www.soberlife-coach.com/` with Vercel HTTP 200, title `SoberLife-Coach | Confidential Recovery Coaching`, and recovery-coaching metadata. Post-worthy only if framed as client-delivery proof/local-business web presence work and client permission/privacy boundary is clear. Immediate next actions: update Psychology Today and LinkedIn plus content schedule, collect the remaining half of the $1,500, and decide public post/portfolio use.
...
- **Aya:** anchor client. Completed: $1,500 dashboard. 2026-07-07 JT update: dashboard updates are effectively near-complete; next gate is Gil review/acceptance and proof-safe evidence. Acquisitions remains stalled. Treat Aya as proof-point source only after accepted proof-safe evidence exists; gate: `memory/clients/aya/proof-evidence-checklist.md`.
- **Marketsmith:** active opportunity as of 2026-07-01. Sam asked JT about helping expedite 10-15 priority dashboards in 30 days with AI-generated insights, built in Azure with one active builder and data engineering support. 2026-07-02 meeting felt more like an interview than a standard discovery, but JT thought it went well. They focused heavily on security, scalability, and data intake/accuracy. Useful proposal angles: local/dedicated-PC LLM option for sensitive client-data analysis; agent delivery memory via lessons file after each build; governed data-intake checklist checked after each refresh; Snowflake data with client-specific insight prompts rather than generic Snowflake AI; automated competitor research; and always-on industry research/personal-agent layer. 2026-07-06: Sam sent Nexus SOW for 4 weeks / up to 80 hours covering onboarding, Dashboard Creation Playbook agent, NJ Lottery dashboard, QA agent, and Montclair dashboard. 2026-07-07: Amanda conversation went well; JT quoted $200/hr for 80 hours ($16K) with guardrails for 80-hour container, Week 1 ramp checkpoint, and biweekly invoicing. Same day, Sam rejected $200/hr as outside budget and cited $125-$150 standard range; recommended reply became $150/hr for the initial 80-hour scope ($12K) while keeping scope/ramp/billing guardrails. 2026-07-14: JT met with Karen, VP of Talent & Administration; she said they can no longer afford $150/hr and cited temp-agency benchmarks of $135/hr in office / $100/hr remote, while also saying the team is locked in on JT and wants only him. JT said $135/hr may be his floor. Current tactical recommendation after review: send one fixed-fee proposal at $10,800 for the full Ed SOW scope, structured 50% due at kickoff and 50% due upon completion. Do not send a two-option hourly/fixed menu; do not voluntarily anchor below $10,800; do not accept $100 remote. If Marketsmith counters, preserve the upfront-payment structure and protect scope/change-order boundaries. Avoid raw Azure engineering staff augmentation. Client OS initialized at `memory/clients/marketsmith/`; discovery prep at `memory/clients/marketsmith/discovery-prep-2026-07-01.md`; meeting notes at `memory/clients/marketsmith/meeting-notes-2026-07-02.md`; SOW review at `memory/clients/marketsmith/sow-review-2026-07-06.md`.
...
- Action Arena: 2026-06-18 reset keeps this as gate sprint only. Source is now found/cloned at `/Users/jtsomwaru/projects/action-arena` from `jsomwarux/action-arena`; build gate shifted to Apple Developer Organization transfer + EAS/TestFlight/App Store readiness. JT is moving the Apple Developer membership from individual to organization under the LLC because in-app purchases blocked individual submission. Removed hardcoded Supabase/Odds keys from `eas.json`, wired EAS pre-build mock-data guard, verified typecheck/prod guard/iOS export. Next action: organization transfer clears, then confirm EAS secrets + App Store Connect/TestFlight status, submit by 2026-07-15 or pause until next preseason, then park public launch until football season. Optional paid UGC through SideShift/Home From College is allowed only as a capped kickoff test after app live + attribution ready; Nash is hard no, Glow low priority with compliance scripting.
