...
- Active cron count: 45 enabled / 70 total as of 2026-06-16 after JT cancelled dynasty-related content crons. Disabled: `dynasty-replies-gen`, `reddit-daily-gen`, `Sports GM Weekly Market Report`, and `Daily DynastyJig Niche-Growth X Post Pack`. Evening Digest (`evening-digest-001`) runs daily 7PM ET from `memory/digest-queue.md`; 2PM TikTok warm-up queues to digest, redundant 7:45PM TikTok warm-up is disabled, and Morning Brief opens with a capped 3-item SEND QUEUE. Phase 7 disabled the old 9:45PM `nightly-autonomous-leverage-agent` and 3:20AM `Overnight Autonomy Agent`, replacing them with `Night Autonomy Agent` (`f146d8b8-94e0-49ff-8e4a-5050a284e894`) at 11PM ET. Phase 1 removed 12 disabled zombie jobs and saved baseline delivery metric at `docs/audits/baseline-delivery-2026-06-11.md`.
- 2026-06-22 heartbeat state: cron volume green at 45 enabled, ~176.46/wk, 25.21/day, 21.21 agentTurn/day; current red rows empty; stale cleanup bucket reduced to `Viral Post Swipe File - X Research`, `Weekly Systems Review`, and `content-generate-x`. Duplicate `lossless-claw` plugin warning persists. Do not blind-rerun content/reporting jobs solely to clear stale metadata.
