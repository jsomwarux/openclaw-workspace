...
- Last completed run: 2026-09-18T05:20:00-04:00
- Cursor: rolling 30-day window 2026-08-20 through 2026-09-18; next run retains a rolling 30-day window and does not exclude still-live roles by cursor
...
- Last failure: no run-level failure; the SmartRecruiters-only query returned 1 result, but aggregate search health passed with 164 unique discovery URLs
- Started marker: clear
- Next expected run: 2026-09-21T05:15:00-04:00
- Legacy definition: `config/cron-snapshots/job-pipeline-legacy-before-reactivation-2026-08-22.json`

## Latest Run

- Run timestamp: 2026-09-18T05:15:00-04:00 through 2026-09-18T05:20:00-04:00
- Searches executed: 12 rolling-month broad query families with 15 results requested per query; 11 returned 15 results and the SmartRecruiters-only query returned 1. Seven targeted validation searches plus direct live-page checks followed.
- URLs checked: 164 unique discovery URLs from 166 raw search results; every discovery URL and targeted candidate outcome is recorded in the run audit.
...
- Artifacts: `/Users/jtsomwaru/projects/job-market-agent/data/daily-brief.md`; `/Users/jtsomwaru/projects/job-market-agent/data/job-opportunities.md` (checked, unchanged); `/Users/jtsomwaru/projects/job-market-agent/data/search-results/2026-09-18-job-market-audit.md`; `/Users/jtsomwaru/projects/job-market-agent/data/search-results/2026-09-18/`; `/Users/jtsomwaru/.openclaw/workspace/memory/job-state/job-market-daily-research.md`.
- Failures: no run-level failure. The SmartRecruiters-only query returned one result; all stale, duplicate, and non-qualifying pages are recorded individually, and aggregate search health passed.
- Cursor/date: rolling 30-day window 2026-08-20 through 2026-09-18
- Proof log: `86766a99`
- Next run: 2026-09-21T05:15:00-04:00

## Recent Runs

- 2026-09-18 05:20 ET: twelve broad rolling-month searches produced 166 raw results and 164 unique URLs; no evidence-backed role cleared every gate.
