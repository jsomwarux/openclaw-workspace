...
### Reuse
- format:slideshow (2 winner rows)
- hook:contradiction (1 winner rows)
- topic:game_theory_explainer (1 winner rows)
- specificity:low (1 winner rows)
- proof:none (1 winner rows)
- hook:specific_number_unexpected_context (1 winner rows)
...
- hook:specific_number_unexpected_context (1 winner rows)
- topic:model_consensus (1 winner rows)
- format:status_update (1 winner rows)
- specificity:high (1 winner rows)
- proof:model_names (1 winner rows)
### Avoid / Rework
...
### Reuse
- topic:rating_precision (2 winner rows)
- format:slideshow (2 winner rows)
- proof:none (2 winner rows)
- hook:specific_number_unexpected_context (1 winner rows)
- specificity:high (1 winner rows)
