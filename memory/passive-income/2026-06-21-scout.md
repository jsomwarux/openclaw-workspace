...
- `weekly-trends.md`: present, 68240 bytes
- `weekly-exploding-topics.md`: present, 53625 bytes
- `weekly-google-trends.md`: present, 3172 bytes
- `weekly-apis.md`: present, 855 bytes
- `weekly-trustmrr.json`: present, 27665 bytes
