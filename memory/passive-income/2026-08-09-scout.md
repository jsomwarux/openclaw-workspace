# Passive Income Scout - 2026-08-09
...
- `weekly-trends.md`: present, 68401 bytes
- `weekly-exploding-topics.md`: present, 38357 bytes
- `weekly-google-trends.md`: present, 2546 bytes
- `weekly-apis.md`: present, 917 bytes
- `weekly-trustmrr.json`: present, 27846 bytes

## Signal Seeds

- Weekly Google Trends — 2026-08-08
