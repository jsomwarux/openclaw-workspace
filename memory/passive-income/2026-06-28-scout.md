# Passive Income Scout - 2026-06-28
...
- `weekly-trends.md`: present, 68398 bytes
- `weekly-exploding-topics.md`: present, 48013 bytes
- `weekly-google-trends.md`: present, 2993 bytes
- `weekly-apis.md`: present, 909 bytes
- `weekly-trustmrr.json`: present, 27555 bytes
