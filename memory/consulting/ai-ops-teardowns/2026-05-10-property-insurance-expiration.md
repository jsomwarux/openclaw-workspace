...
## Proof-Safety Note
Use this as a public/hypothetical category teardown. Do not name Altmark, Aya, Yair, Navid, Matt, or any private client. Do not claim ROI, hours saved, records tracked, client acceptance, or a live named-client deployment unless the relevant proof gate has verified evidence and permission.
